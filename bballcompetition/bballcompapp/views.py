...
def trackerpage(request):
    ...
    # Process form data and save to database
        ...
        user = User(phone_number=phone_number, email=email_address)
    ...
    return render(request, 'bballcompapp/trackerpage.html', {'games': filtered_games})


def notificationhome(request):
    return render(request, 'bballcompapp/notificationhome.html')
